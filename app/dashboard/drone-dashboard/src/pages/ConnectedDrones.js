...
import '../styles/Overview.css'; // Reusing the same styles for now
import '../styles/MissionConfig.css';

// Components from MissionConfig
...
const ConnectedDrones = ({ setSelectedDrone }) => {
  ...
  return (
    <div className="connected-drones-container">
        <div className="tabs-container">
          <div
            className={`tab-item ${activeTab === 'drones' ? 'active' : ''}`}
            onClick={() => setActiveTab('drones')}
          >
            <span className="tab-label">Connected Drones</span>
          </div>
          <div
            className={`tab-item ${activeTab === 'config' ? 'active' : ''}`}
            onClick={() => setActiveTab('config')}
          >
            <span className="tab-label">Mission Configuration</span>
          </div>
        </div>
      ...
      {activeTab === 'drones' && (
        ...
        {activeTab === 'config' && <MissionConfig />}
    </div>
  );
};

ConnectedDrones.propTypes = {
